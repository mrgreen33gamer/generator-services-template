...
// PowerHold Generators — Contact Page (unique build, not just a form import)
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 991-2121. We answer 7 days a week including evenings. For a genuine generator emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial generator systems?',
    answer: 'Yes — light commercial generator for restaurants, offices, ranch spaces, and small barns is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  },
  {
    ...
    answer: "Our tech will tell you honestly after the diagnosis. If the repair cost exceeds 50% of a new generator's cost and your generator is over 15�20 years old, we'll recommend replacement — but we'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@powerholdgenerators.com',
                  href:      'mailto:hello@powerholdgenerators.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1800 Franklin Ave, Waco TX 76701',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose PowerHold Generators</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'TECL-aligned installers only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed PowerHold Generators generator technician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549912121">(254) 991-2121</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 991-2121 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 991-2121"
        primaryLink="tel:+12549912121"
        secondaryText="Send a Text"
        secondaryLink="sms:+12549912121"
      />
