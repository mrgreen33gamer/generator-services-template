...
// PowerHold Generators — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full generator repair, component & cable repair, pad and hardware, lighting, generator maintenances, and commercial generators across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full generator coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Standby system upgrades'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Storm-Ready Install Guarantee · 2-Year Workmanship as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Storm-Ready Install Guarantee · 2-Year Workmanship', 'TECL-aligned'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable generator service for Bellmead residents and businesses. Standby system upgrades, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'TECL-aligned generator technicians', 'No contracts'],
  },
  {
    city:        'China Spring',
    slug:        'china-component-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential generator service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Generator repair, component & cable repair, and shop power for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'Standby system upgrades', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Generator repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service generator coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial generator.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial generator in all areas?',
    answer: 'Yes — light commercial generator for restaurants, offices, ranch spaces, and small barns is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Generator — Since 2011
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, TECL-aligned generator technicians, and a Storm-Ready Install Guarantee · 2-Year Workmanship — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12549912121" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common generator issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12549912121" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12549912121" className={styles.unlistedCTA}>
            Call (254) 991-2121
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Storm-Ready Install Guarantee · 2-Year Workmanship, no contracts ever."
