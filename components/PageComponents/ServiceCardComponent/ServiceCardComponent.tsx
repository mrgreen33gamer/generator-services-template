...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Backup Power Needs',
  subheading = 'From emergency outages to whole-home standby installs, PowerHold Generators handles it all — on time, on price.',
