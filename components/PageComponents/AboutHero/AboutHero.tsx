      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas generator<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            PowerHold Generators has been keeping homes and businesses comfortable in{' '}
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="PowerHold Generators — Waco, Texas generator technicians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>PowerHold Generators</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted generator</span>
              </div>
            </div>
          </div>
        </motion.div>
