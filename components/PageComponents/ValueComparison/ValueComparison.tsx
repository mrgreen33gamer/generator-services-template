...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Storm-Ready Install Guarantee · 2-Year Workmanship', us: true,  others: false },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'PowerHold Generators vs. The Other Guys' }: ValueComparisonProps) {
  return (
