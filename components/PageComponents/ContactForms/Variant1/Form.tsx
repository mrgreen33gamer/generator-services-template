...
const SERVICES = [
  { icon: faWrench,          label: 'Standby Generators' },
  { icon: faLink,            label: 'Portable Generators' },
  { icon: faDoorOpen,        label: 'New Generator Install' },
  { icon: faCogs,            label: 'Transfer switch Install' },
  { icon: faClipboardList,   label: 'Maintenance Plan' },
  { icon: faBuilding,        label: 'Emergency Service' },
...
const TRUST_CHIPS = [
  ...
  { icon: faStar,         text: '4.9★ · 520+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed PowerHold Generators technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12549912121"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 991-2121', section: 'ContactForm-V1' })}>
                          Call (254) 991-2121
                        </a>
                      </span>
                    </div>
