...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "Storm-Ready Install Guarantee · 2-Year Workmanship",
    description:
  ...
  {
    icon: faCertificate,
    title: "TECL-Aligned Installers",
    description:
      "Every generator technician who enters your home is TECL-aligned. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every generator company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, TECL-aligned generator technicians, and a Storm-Ready Install Guarantee · 2-Year Workmanship on every install we touch.
          </p>
          <Link
            href={ctaLink}
