        ...
        <div className={styles.storyBody}>
          <div className={styles.storyPull}>
            <p className={styles.pullQuote}>
              "We started PowerHold Generators because we were tired of watching homeowners get ripped off by fly-by-night generator contractors."
            </p>
            <div className={styles.pullAttrib}>
              <span className={styles.pullName}>— Rhea Colton</span>
              <span className={styles.pullTitle}>Founder, PowerHold Generators</span>
            </div>
          </div>

          <div className={styles.storyText}>
            <p className={styles.storyParagraph}>
              Founded in 2011 in Waco, TX, PowerHold Generators started with one truck and one principle:
            ...
            <p className={styles.storyParagraph}>
              ...
              from China Spring to Killeen — with a crew of TECL-aligned, TECL-aligned installers
